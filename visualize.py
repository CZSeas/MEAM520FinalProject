...
def plot_obstacle(ax, obstacle):
    ...
    # inside surface
    ax.plot_wireframe(x1, y12, z1, color='b', rstride=3, cstride=3, alpha=0.6)
    # bottom surface
    ax.plot_wireframe(x2, y2, z21, color='b', rstride=3, cstride=3, alpha=0.6)
    # upper surface
    ax.plot_wireframe(x2, y2, z22, color='b', rstride=3, cstride=3, alpha=0.6)
    # left surface
    ax.plot_wireframe(x31, y3, z3, color='b', rstride=3, cstride=3, alpha=0.6)
    # right surface
    ax.plot_wireframe(x32, y3, z3, color='b', rstride=3, cstride=3, alpha=0.6)
